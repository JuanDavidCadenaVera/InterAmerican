...
public class Estudiante extends Personas implements Horario, Nivel {
    ...
    try {
        String sql = "SELECT P.TbP_Nombre, P.TbP_Apellido, P.TbP_Direccion_Email, " +
                     ...
                     "P.TbP_Tipo_Documento, P.TbP_ID_Personas, M.TbM_ID_Matricula, " +
                     "N.TbN_ID_Nota AS Nota_Final, P.TbP_Direccion, P.TbP_Telefono " +
                     "FROM tb_personas P " +
        ...
        while (rs.next()) {
            ...
            String numeroDocumento = rs.getString("TbP_ID_Personas");
            String idMatricula = rs.getString("TbM_ID_Matricula");
